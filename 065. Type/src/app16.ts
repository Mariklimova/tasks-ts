...
// 2
const min_16: number = Math.min(...arr_16)
if (arr_16[0] == min_16) console.log('массив со строго возрастающей последовательностью');
else console.log('не является массивом со строго возрастающей последовательностью');
